...
namespace ACUDECIDE
{
    class Clscs
    {
        ...
        public Clscs(DataGridView gridview, string ReportHeader, int count)
        {
            ...
            while (iRow <= gw.Rows.Count - 1)
            {
                ...
                else
                {
                    ...
                    if (bNewPage)
                    {
                        ...
                        graphic.DrawString("ALFRED GARDENS ESTATE, OJOTA.", new Font("Courier New", 24), new SolidBrush(Color.DarkRed), startX - 30, startY);
                        graphic.DrawString(" " + String.Format("{0}", _ReportHeader), new Font("Courier New", 16), new SolidBrush(Color.Black), 230, offset1 + 15);

                        graphic.DrawString("Total : ".PadRight(10) + String.Format("{0}", _count - 1), new Font("Courier New", 12), new SolidBrush(Color.Black), 95, offset1 + 40);
                        graphic.DrawString("Printed On : ".PadRight(10) + String.Format("{0}", date), new Font("Courier New", 12), new SolidBrush(Color.Black), 460, offset1 + 40);
